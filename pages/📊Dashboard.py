...
# Mostrar el Iframe
iframe_code = """
<div style="display: flex; justify-content: center; align-items: center; height: 80vh; width: 60vw; overflow: hidden; margin: auto;">
    <iframe title="AnalisisExtranjeros_Entradas_24/01" style="width: 100%; height: 100%; margin-left: -50px;" 
